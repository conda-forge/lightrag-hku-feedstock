...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/lightrag-hku-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/lightrag-hku-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add lightrag-hku
# for installing globally
pixi global install lightrag-hku
```
...
It is possible to list all of the versions of `lightrag-hku` available on your platform:
...
```
pixi search lightrag-hku --channel conda-forge
```
